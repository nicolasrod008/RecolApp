...
<html>
<head>
  <title>Inserter Empresa Generadora</title>
</head>
<body>
...
<nav>
  ...
  <h3>Insertar Empresa Generadora</h3><br><br>
...
<?php
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into empresageneradora(Nombre,Direccion,Telefono,Nit) values("'.$_POST['txtNombre'].'","'.$_POST['txtDireccion'].'","'.$_POST['txtTelefono'].'","'.$_POST['txtNit'].'")';
