...
<head>
  <title>Actualizar Empresa Generadora</title>
</head>
...
<?php 
   ...
   $consulta="SELECT  * FROM  empresageneradora eg WHERE IdEmpresaGeneradora='$editar_id'";
 ...
 ?>
  ...
  <tr>
    <td><h3>Nit:</h3></td>
    <td><input type="text" name="txtNit" value="<?php echo $nit;?>"></td>
  </tr>
...
if (isset($_POST['actualizar']))
 {  
  ...
  $actualizar="UPDATE  empresageneradora  SET  Nombre='$nombree', Direccion='$direc', Telefono='$tel', Nit='$niit' WHERE IdEmpresaGeneradora='$editar_id'";
