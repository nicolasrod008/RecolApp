...
<html lang="en">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="entregaempresa.php" method="post" data-parsley-validate class="form-horizontal form-label-left">

                      <?php 
                         if(isset($_GET['actualizar'])){
                         $editar_id = $_GET['actualizar'];
                         $_SESSION['id']=$editar_id;

                         $consultaa="SELECT  * FROM  residuo WHERE IdResiduo=$editar_id";
                         $ejecutar=$con->query($consultaa);
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date"  name="txtFecha" value="<?php echo $fecha;?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectResiduo">
                            <option value="<?php echo $idresiduo;?>"><?php echo $idresiduo;?></option>
                              <?php
  ...
  if(isset($_POST['Enviar'])){
      ...
      $sql1='insert into entregaresiduo(IdEmpresaRecolectora,Fecha,PesoReal,Costo,IdResiduo,IdEstado) values('.$_POST['selectEmpresa'].',"'.$_POST['txtFecha'].'","0","0","'.$_POST['selectResiduo'].'","1")';

      $sql="UPDATE residuo SET IdEstado='1' WHERE IdResiduo=". $_SESSION['id'];
    ...
    if($result and $result1)
      {
      echo "<script> alert('Felicitaciones!!! Se a asignado una recogida para este residuo')</script>";
