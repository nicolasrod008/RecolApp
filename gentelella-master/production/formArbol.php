          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Insertar Donativo de un Arbol</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos del Donativo <small>elementos de insercion</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formArbol.php" method="post" data-parsley-validate class="form-horizontal form-label-left">


                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo de Arbol</label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Entrega en la que se dono</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectEntrega">
                            <option value="0"></option>
                             <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="last-name" name="txtFoto" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>                                            
                      </div>
