          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos del Convenio <small>Verifique los datos ingresados</small></h2>
                  ...
                  <div class="x_content"><br>
                    ...
                    <form id="demo-form2" name="form" action="formConvenio.php" method="post" class="form-horizontal form-label-left" >                      
           
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Empresa Recolectora *</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectEmpresaR">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Empresa Generadora</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectEmpresaG">
                            <option value="0"></option>
                             <option value="11">No</option>
                                <?php
                                 ...
                                 $ejecutar = $con->query($sql);
                                 while ($res=$ejecutar->fetch_assoc()) {
                                  echo "<option value = '".$res['IdEmpresaGeneradora']."'>".$res['NombreEmpresaG']."</option>";
                                 }
                                ?>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Usuario</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fechaInicio">Fecha De Inicio <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" name="txtFechaInicio" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" placeholder="both name(s) e.g Jon Doe" required="required" type="date">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="fechaFin">Fecha De Fin 
                        </label>
                        <div class="col-md-5 col-sm-6 col-xs-12">
                          <input id="name" name="txtFechaFin" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" type="date">
                        </div>
                        <div class="checkbox">
                            <label>
                              <input type="checkbox" name="txtFechaFin" checked="checked"> Sin Limite
                            </label>
                          </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cosot">Csoto<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="txtCosto" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Dirigido <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select name="selectDirigido" class="select2_single form-control" tabindex="-1">
                            <option></option>
