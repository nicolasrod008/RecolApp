            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formEmpresaGeneradora.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="txtNit" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
...
<?php
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into empresageneradora(NombreEmpresaG,Direccion,Telefono,Nit) values("'.$_POST['txtNombre'].'","'.$_POST['txtDireccion'].'","'.$_POST['txtTelefono'].'","'.$_POST['txtNit'].'")';
