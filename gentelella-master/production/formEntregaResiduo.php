...
<html lang="en">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos de la Entrega <small>elementos de insercion</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formEntregaResiduo.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date"  name="txtFecha" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="txtPeso" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Empresa Recolectora</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectEmpresa">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Estado de la entrega</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectEstado">
                            <option value="0"></option>
                              <?php
                                 $sql="select * from estadoer";  
                                 $ejecutar = $con->query($sql);
                                 while ($res=$ejecutar->fetch_assoc()) {
                                  echo "<option value = '".$res['IdEstado']."'>".$res['NombreEstado']."</option>";
                                 }
                              ?>
                          </select>
                        </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Seleccionar Numero de envio del Residuo</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select class="form-control" name="selectResiduo">
                            <option value="0"></option>
                              <?php
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into entregaresiduo(IdEmpresaRecolectora,Fecha,PesoReal,Costo,IdResiduo,IdEstado) values('.$_POST['selectEmpresa'].',"'.$_POST['txtFecha'].'","'.$_POST['txtPeso'].'","'.$_POST['txtCosto'].'","'.$_POST['selectResiduo'].'","'.$_POST['selectEstado'].'")';
