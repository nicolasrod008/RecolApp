...
<html lang="en">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formResiduo.php" method="post" data-parsley-validate class="form-horizontal form-label-left">


                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Usuario que entrega el residuo</label>
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into residuo(IdUsuario,IdTipo,PesoAproximado,Donativo) values("'.$_POST['selectUsuario'].'","'.$_POST['selectConvenio'].'","'.$_POST['selectTipo'].'","'.$_POST['txtPeso'].'")';
