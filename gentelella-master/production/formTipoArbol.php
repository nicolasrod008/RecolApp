...
<html lang="en">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formTipoArbol.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into tipoa(NombreTipoA) values("'.$_POST['txtNombre'].'")';
