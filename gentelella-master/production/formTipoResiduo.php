...
<html lang="en">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Insertar Tipo de Residuo</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos <small>elementos de insercion</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="formTipoResiduo.php" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="txtNombre" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>                                            
                      </div>
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into tipo(NombreTipoR) values("'.$_POST['txtNombre'].'")';
