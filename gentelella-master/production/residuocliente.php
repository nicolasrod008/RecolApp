...
<html lang="en">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Datos del Residuo <small>elementos de insercion</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" name="form" action="residuocliente.php" method="post" data-parsley-validate class="form-horizontal form-label-left">


                     <div class="form-group">
                          <input type="hidden" id="last-name" name="txtId" class="form-control col-md-7 col-xs-12">                        
                     </div>
                      
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tipo de Residuo</label>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Fecha de Recogida<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="last-name" name="txtFecha" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Peso Aproximado<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Donativo *</label>
                        <div class="col-md-6 col-sm-9 col-xs-12">
                          <select name="selectDonativo" class="select2_single form-control" tabindex="-1">
                            <option></option>
  ...
  if(isset($_POST['Enviar'])){
      $sql='insert into residuo(IdUsuario,IdTipo,Fecha,PesoAproximado,Donativo) values("'.$_SESSION['idusu'].'","'.$_POST['selectTipo'].'","'.$_POST['txtFecha'].'","'.$_POST['txtPeso'].'","'.$_POST['selectDonativo'].'")';
